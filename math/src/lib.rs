...
/// Verifies if número é aproximadamente zero
pub fn is_zero(x: f64) -> bool {
    x.abs() < EPSILON
}

/// Verifies if dois números são aproximadamente iguais
pub fn approx_equal(a: f64, b: f64) -> bool {
    (a - b).abs() < EPSILON
}

/// Normaliza ângulo for interval [0, 2π)
...
/// Bessel function J0 (ordem 0) - aproximação
