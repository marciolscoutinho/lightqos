...
class QuantumTeleportationProtocol :
    ...
    def setup_entanglement (self )->Tuple [int ,int ]:
        ...
        # Generate EPR pair
        pair_id =self .emf .generate_pair (
        qubit_a =0 ,
        qubit_b =1 ,
        fidelity =0.99 
        )
    ...
    def run_complete_protocol (self ):
        ...
        # 1. Setup
            ...
            (self .stats ['avg_fidelity']*(self .stats ['total_teleportations']-1 )
            +fidelity )/self .stats ['total_teleportations']
            )
    ...
    def print_statistics (self ):
        ...
        print (f"Taxa de sucesso:          {self .stats ['successful']/max (1 ,self .stats ['total_teleportations'])*100 :.1f}%")
