...
protocols = pytest.importorskip(
    "lightqos.protocols",
    reason="lightqos.protocols is not implemented yet",
)

core = pytest.importorskip(
    "lightqos.core",
    reason="lightqos.core is not implemented yet",
)

QuantumTeleportation = protocols.QuantumTeleportation
BB84Protocol = protocols.BB84Protocol
