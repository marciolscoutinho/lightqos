        ...
        def validate():
            for _ in range(10000):
                manager.validate_execution(
                    contract, duration_ns=500_000, phase_error=0.005, fidelity=0.97
                )
...
def test_comparison_memory_usage():
    ...
    print("\n=== Memory Usage ===")
    print("1000 pairs managed by Rust")
    print("Zero-copy between Python and Rust ✓")
