...
impl Certifier {
    ...
    pub fn certify(&self, shadows: &ShadowCopyResult, confidence: f64) -> StatisticalCertificate {
    ...
    fn compute_error_bounds(&self, shadows: &ShadowCopyResult) -> ErrorBounds {
        ...
        // Relative error
        let mean_exp: f64 =
            shadows.expectations.values().sum::<f64>() / shadows.expectations.len() as f64;
    ...
    fn assess_sample_adequacy(
        ...
        let max_variance: f64 = shadows.variance.values().fold(0.0_f64, |a, &b| a.max(b));
