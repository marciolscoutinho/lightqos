...
class CircuitTransformer:
    ...
    async def transpile(self, circuit: Circuit, target_backend: str) -> Circuit:
        """
    ...
    async def _transformer_transpile(self, circuit: Circuit, target_backend: str) -> Circuit:
        ...
        return Circuit(
            gates=transpiled_gates, num_qubits=circuit.num_qubits, backend=target_backend
        )
    ...
    def _decode(self, encoded: np.ndarray, target_backend: str) -> List[int]:
        """
        Simplified decoder
    ...
    def _lightqos_to_qiskit(self, circuit: Circuit) -> Circuit:
        ...
        return Circuit(gates=circuit.gates.copy(), num_qubits=circuit.num_qubits, backend="qiskit")
    ...
    def _lightqos_to_ionq(self, circuit: Circuit) -> Circuit:
        ...
        return Circuit(gates=ionq_gates, num_qubits=circuit.num_qubits, backend="ionq")

    def _qiskit_to_lightqos(self, circuit: Circuit) -> Circuit:
        """Qiskit → LightQOS"""
        return Circuit(
            gates=circuit.gates.copy(), num_qubits=circuit.num_qubits, backend="lightqos"
        )
