...
impl QuantumShadow {
    ...
    pub fn reconstruct_density_matrix(&self) -> Result<DMatrix<Complex<f64>>, String> {
        ...
        // Normalize
        rho /= (self.num_snapshots as f64).into();
...
impl ShadowCollector {
    ...
    fn update_stats(&mut self) {
        ...
        let total: f64 = self.shadows.values().map(|s| s.metadata.confidence).sum();
