...
// octave_algebra.rs — Octave Algebra — 10 electromagnetic octave bands for EFAL
//
...
/// Position in the Locked Potentials Formula
...
impl OctavePosition {
    /// Returns the numerical index, from -4 to +4
...
/// Energy required for transition between octaves.
