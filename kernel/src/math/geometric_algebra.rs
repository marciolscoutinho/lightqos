...
// geometric_algebra.rs — Geometric Algebra GA(3,0) — multivectors and geometric products
//
...
impl GA3D {
    ...
    pub fn e2() -> Self {
        GA3D::new(0.0, 1.0, 0.0)
    }
    pub fn e3() -> Self {
        GA3D::new(0.0, 0.0, 1.0)
    }
    ...
    /// Normalizes the vector, unit vector
    ...
    /// Exterior product, wedge product, returns a bivector.
...
pub struct Bivector3D {
    pub xy: f64, // e1 ∧ e2 component
    pub yz: f64, // e2 ∧ e3 component
    pub zx: f64, // e3 ∧ e1 component
}
...
impl Multivector3D {
    ...
    pub fn geometric_product(a: &Multivector3D, b: &Multivector3D) -> Multivector3D {
        ...
        // Simplified - the complete version requires full expansion

        let scalar = a.scalar * b.scalar + a.vector.dot(&b.vector)
            - a.bivector.xy * b.bivector.xy
            - a.bivector.yz * b.bivector.yz
            - a.bivector.zx * b.bivector.zx
            - a.trivector * b.trivector;

        let vector = b.vector * a.scalar + a.vector * b.scalar + a.vector.cross(&b.vector);
