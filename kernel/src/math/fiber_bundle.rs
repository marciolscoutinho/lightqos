...
// fiber_bundle.rs — Fiber Bundles — differential geometry over quantum state spaces
//
...
pub struct GaugeField {
    /// Transport matrix, simplified as phase
    pub phase: f64,
    pub amplitude: f64,
}
...
/// Fiber bundle section, global state
pub struct Section {
